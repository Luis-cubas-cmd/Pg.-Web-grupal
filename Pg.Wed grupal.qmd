...
3.  Vincular repositorio con el nuevo proyecto, ingresando los siguientes comandos en la terminal:
    ...
    git branch -M main
    git remote add origin [https://github.com/Luis-cubas-cmd/Pg.-Web-grupal
    ](https://github.com/Luis-cubas-cmd/Pg.-Web-grupal)git push -u origin main
...
```{r}
modelo <- aov(ttrans ~ riego * geno + leafdw * riego * geno, data = data)
